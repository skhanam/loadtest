...
import com.test.shoop.pages.ValidateErrorMessageRegisterPage;

import cucumber.api.java.en.And;
import cucumber.api.java.en.Then;

public class ValidateErrorMessageRegisterStepdef extends AbstractDriver{
	
	ValidateErrorMessageRegisterPage vemrp = PageFactory.initElements(driver, ValidateErrorMessageRegisterPage.class);
